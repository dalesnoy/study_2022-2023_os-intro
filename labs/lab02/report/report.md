...
![имя и email владельца репозитория](image/1.png){#fig:001 width=90%}
...
![Настройка верификации и подписания коммитов git](image/2.png){#fig:002 width=90%}

3. Далее создаем ssh и gpg ключи (рис. [-@fig:003]), (рис. [-@fig:004]). 

![Настройка верификации и подписания коммитов git](image/3.png){#fig:003 width=90%}

![Настройка верификации и подписания коммитов git](image/4.png){#fig:004 width=90%}
...
git config --global user.signingkey <PGP Fingerprint>  (рис. [-@fig:005])
git config --global commit.gpgsign true
git config --global gpg.program $(which gpg2)

![Настройка автоматических подписей коммитов git](image/5.png){#fig:005 width=90%}
...
![Настройка каталога курса](image/6.png){#fig:005 width=90%}
![Отправьте файлы на сервер:](image/6.png){#fig:005 width=90%}
...
3)Что представляют собой и чем отличаются централизованные и децентрализованные VCS? Приведите 
...
Изучили идеология и применение средств контроля версий.
